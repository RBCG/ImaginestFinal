<?php
    ...
    function enviarMail($email, $activationCode)
    {
        ...
        <div style="position: relative; background: #0bbcdb; height: 240px; padding: 1px; outline: none; box-sizing: border-box; display:block;">
            ...
            <a style="position: relative; display:block; text-align: center; font-size: 30px;" href="http://localhost/imaginest/mailCheckAccount.php?code=' . $activationCode . '&mail=' . $email . '&msg3=true">Activa tu cuenta!</a>
        </div>
        ');
