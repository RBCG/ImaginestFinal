<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        $nombreFoto = filter_input(INPUT_POST, 'photoOcultaBorrar');
        eliminarPhoto($nombreFoto);
    }
...
<body>
    ...
    <!-- TITULO IMAGINEST + PERFIL DEL USUARIO -->
    ...
    <!-- ARRAY CON LAS FOTOS DEL USUARIO + PINTARLAS -->
    <?php 
